...
int main()
{
    ...
    a.Update(octagon(Point(3, 4), Point(1, 2), Point(5, 6), Point(2, 8),
    Point(3, 1), Point(2, 6), Point(9, 5), Point(5, 4)), ""); // 1
    a.Update(octagon(Point(81, 5), Point(1, 5), Point(16, 6), Point(3, 6),
    Point(1, 8), Point(4, 2), Point(7, 3), Point(1, 15)), "c"); // 2
    a.Update(octagon(Point(8, 5), Point(9, 1), Point(7, 3), Point(1, 8),
